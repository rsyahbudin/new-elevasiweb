        ...
        <main className="px-5 pb-10 pt-36 md:px-10 md:pt-[170px]" ref={containerRef}>
            ...
            <div className="mt-12 grid grid-cols-1 gap-8 md:mt-[60px] md:grid-cols-2 md:gap-10">
                {content.values.map((value, i) => (
                    <div
                        key={value.title}
                        className="group rounded-sm border border-transparent p-4 transition hover:border-[rgba(27,28,26,0.08)] hover:bg-[rgb(236,236,232)]"
                        data-reveal={i * 80}
                    >
                        <h3 className="mb-3 text-[22px] font-semibold uppercase tracking-[-0.01em] transition group-hover:translate-x-1 group-hover:text-[rgb(31,122,70)]">
                            {value.title}
                        </h3>
